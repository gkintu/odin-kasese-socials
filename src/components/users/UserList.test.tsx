...
describe('UserList', () => {
  ...
  it('should render a UserListItem for each user in the list', () => {
    render(
      <UserList users={dummyUsers} onToggleFollow={mockPageToggleFollow} />
    );
  ...
  it('should render an empty state message if no users are provided', () => {
    ...
    expect(
      screen.getByText(/No users found at this time./i)
    ).toBeInTheDocument();
