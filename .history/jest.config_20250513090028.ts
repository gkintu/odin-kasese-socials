...
const config: Config = {
  ...
  setupFilesAfterEnv: ['<rootDir>/jest.setup.ts'], // This points to a file that I want to run after Jest is set up, for my global test configurations.
  testTimeout: 30000, // Increased global timeout to 30 seconds
