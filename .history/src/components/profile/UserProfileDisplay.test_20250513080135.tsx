...
describe('UserProfileDisplay', () => {
  ...
  it('should render user information correctly', () => {
    ...
    expect(profilePic.getAttribute('src')).toContain(
      encodeURIComponent(defaultProps.avatarUrl)
    );
  ...
  it('renders with provided props', () => {
    ...
    expect(avatarImage).toBeInTheDocument();
    expect(avatarImage.getAttribute('src')).toContain(
      encodeURIComponent(testProps.avatarUrl)
    );
  });
  ...
  it('renders with a specific avatarUrl if provided, including the default path', () => {
    ...
    render(
      <UserProfileDisplay {...defaultProps} avatarUrl="/img/default-avatar.png" />
    );
    const avatarImage = screen.getByAltText('Profile picture');
    expect(avatarImage.getAttribute('src')).toContain(
      encodeURIComponent('/img/default-avatar.png')
    );
  });
