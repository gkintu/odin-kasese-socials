...
interface EditProfileFormProps {
  ...
  initialData: {
    ...
    displayName: string;
    bio: string;
    currentAvatarUrl?: string; // Assuming initialData now provides currentAvatarUrl
  };
...
const EditProfileForm: React.FC<EditProfileFormProps> = ({
  ...
  const [imagePreviewUrl, setImagePreviewUrl] = useState<string | null>(initialData.currentAvatarUrl || null); // Assuming initialData now provides currentAvatarUrl
