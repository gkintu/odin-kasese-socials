...
const CreatePostForm: React.FC<CreatePostFormProps> = ({ onSubmit, isSubmitting, onCancel }) => {
  ...
  return (
    ...
    <form onSubmit={handleSubmit(processSubmit)} className="space-y-4">
      {/* Content Text Area */}
      <div>
        <label htmlFor="contentText" className="block text-sm font-medium text-gray-700 sr-only">
          What's on your mind?
        </label>
        <textarea
          id="contentText"
          ...
          {...register('contentText', {
            ...
            maxLength: { value: 500, message: 'Post content must be 500 characters or less' },
          })}
