...
jest.mock('react-hot-toast', () => {
  // Create a mock function for the default export (toast())
  const mockDefault = jest.fn();

  // Assign mock functions for named exports (toast.success, toast.error, etc.)
  // as properties of the mockDefault function.
  mockDefault.success = jest.fn();
  mockDefault.error = jest.fn();
  mockDefault.loading = jest.fn();
  mockDefault.custom = jest.fn();
  mockDefault.dismiss = jest.fn();
  mockDefault.remove = jest.fn();
  mockDefault.promise = jest.fn();
  // Add any other methods from react-hot-toast that are used by Navbar.tsx

  return {
    __esModule: true, // This is important for ES modules
    default: mockDefault, // The default export is our enhanced mock function
    // If Navbar.tsx also used named imports like `import { success } from 'react-hot-toast'`,
    // they would be explicitly mocked here, e.g.:
    // success: mockDefault.success,
  };
});
