...
const Navbar: React.FC = () => {
  ...
  const { isAuthenticated, userEmail, isGuest, logout, displayName } = useAuthStore();
      ...
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="space-x-4 flex items-center">
          {isAuthenticated ? (
            ...
            <>
              {/* Use displayName if available, fallback to derived from userEmail */}
              <span className="mr-2 hidden sm:inline">
                Welcome, {displayName || userEmail?.split('@')[0] || 'User'}!
              </span>
              <Link
                href="/dashboard"
