...
// Mock the @headlessui/react Menu component to simplify testing
jest.mock('@headlessui/react', () => {
  const Fragment = ({ children }: { children: React.ReactNode }) => <>{children}</>;
  return {
    Menu: ({ as: Component = 'div', children }: { as?: React.ElementType, children: React.ReactNode }) => {
...
// Mock the @headlessui/react Menu component to simplify testing
jest.mock('@headlessui/react', () => ({
  Menu: ({ children, as: Component = 'div' }) => {
