...
jest.mock('@/components/profile/UserProfileDisplay', () => {
  ...
  return ({ displayName, userEmail }: { displayName?: string, userEmail?: string }) => (
...
describe('ProfilePage', () => {
  ...
  it('should render loading message when isLoading is true', () => {
    setMockAuthState({ isLoading: true, isAuthenticated: false, isGuest: false });
    render(<ProfilePage />);
  ...
  it('should render guest message when user is a guest', () => {
    setMockAuthState({ isGuest: true, isLoading: false, isAuthenticated: false });
    render(<ProfilePage />);
