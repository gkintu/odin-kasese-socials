...
const ProfilePage: React.FC = () => {
  ...
  const PageContent: React.FC = () => {
    ...
    if (isAuthenticated && userEmail) {
      return (
        <UserProfileDisplay
          displayName={userEmail.split('@')[0]} // Extracts 'user' from 'user@example.com'
          userEmail={userEmail}
          bio="A passionate Kasese Socials user. Ready to connect and share! This is a default bio, update it soon."
          avatarUrl="/img/default-avatar.png" // Path to a dummy avatar image
        />
      );
    }
