...
const PageContent: React.FC<PageContentProps> = ({
  ...
  if (isAuthenticated && userEmail) {
    ...
    const bio =
      'A passionate Kasese Socials user. Ready to connect and share! This is a default bio, update it soon.';
    const avatarUrl = '/img/default-avatar.png';

    return (
      <div className="container mx-auto px-4 py-8">
        <UserProfileDisplay
          displayName={displayName || userEmail.split('@')[0]} // Use store's displayName first
          userEmail={userEmail}
          bio={bio}
          avatarUrl={avatarUrl}
          isCurrentUser={true} // Explicitly pass true for the user's own profile page
        />
      </div>
    );
  }
