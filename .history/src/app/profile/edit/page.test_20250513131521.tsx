...
describe('EditProfilePage', () => {
  ...
  it('handleEditProfileSubmit updates display name and redirects', async () => {
    ...
    // Update the EditProfileForm mock to handle form submission with new data
    jest.mock('@/components/profile/EditProfileForm', () => ({
      __esModule: true,
      default: ({ onSubmit }: any) => (
        <form data-testid="mock-edit-profile-form" onSubmit={(e) => {
          ...
          <input aria-label="Display Name" defaultValue="Old Name Store" />
          <button type="submit">Save Changes</button>
        </form>
      ),
    }), { virtual: true });

    // Re-render the component with the new mocks
    render(<EditProfilePage />);
