...
describe('EditProfilePage', () => {
  ...
  it('handleEditProfileSubmit updates display name and redirects', async () => {
    ...
    const mockAuthStoreWithOldName = {
      isAuthenticated: true,
      isGuest: false,
      isLoading: false,
      userEmail: 'test@example.com',
    ...
    mockUseAuthStore.mockReturnValue(mockAuthStoreWithOldName);
    
    jest.resetModules();
    jest.doMock('@/lib/store/authStore', () => ({
      useAuthStore: () => mockAuthStoreWithOldName
    }));
